...
if args.cuda:
    ...
    adj_label1_train = adj_label1[rand_indx, :][:, rand_indx]  #*need double check sparse tensors do not have strides
...
def train(epoch,
    ...
    output,x_dis = model(input_features_train, input_adj_train)
    ...
    #input_adj_train_1 = input_adj_train.to_dense()
