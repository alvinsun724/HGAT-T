...
from util import load_data, accuracy, dense_tensor_to_sparse, resample, makedirs
...
def train(epoch,
    ...
    loss_Ncontrast = Ncontrast(x_dis, input_adj_train, tau=args.tau)
...
# Model and optimizer
    print("\n\nNo. {} test.\n".format(i+1))
    model = HGAT1(input_features_train, nfeat_list=[i.shape[1] for i in features],
