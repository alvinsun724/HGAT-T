...
class HGAT1(nn.Module):
    def __init__(self, features, nfeat_list, nhid, nclass, dropout,
        ...
        self.mlp = Mlp(features, nhid, dropout)
        ...
        self.gc2.append(GraphConvolution(dim_1st, dim_2nd, bias=True))
            ...
            # self.mlp = Mlp(nfeat_list, nhid, dropout)
    ...
    def forward(self, x_list, adj_list, adj_all=None):
        ...
        x_d = self.mlp(x0)
        x_dis = get_feature_dis(x_d)  #newly add
